...
#define GENERATED_BODY() GODOT_GENERATOR_GLUE(FILE_IDENTIFIER, GODOT_GENERATOR_GLUE(__LINE__, GENERATED_BODY()))
#else
#define GENERATED_BODY() GODOT_GENERATOR_GLUE(FILE_IDENTIFIER, GODOT_GENERATOR_GLUE(__LINE__, CORE_GENERATED_BODY()))
#endif
